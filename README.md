...
- **Kategori berwarna, bisa dikustomisasi** — kelola daftar kategori (tambah, ubah nama/warna, hapus) dari tab Pengaturan → Kategori. Kategori juga tersinkron ke cloud per akun (`users/{uid}/settings/categories`), dan bisa disembunyikan/ditampilkan sebagai filter dari layar yang sama. Kategori yang masih dipakai pengingat tidak bisa dihapus sampai pengingatnya dipindah dulu. Di form pengingat, kategori dipilih lewat **dropdown dengan pencarian** — ketik beberapa huruf untuk menyaring daftar (supaya tidak perlu scroll jauh kalau kategorinya banyak), lalu pilih dari daftar yang muncul. Kategori tetap **wajib dipilih dari daftar** (tidak bisa menyimpan nama kategori bebas hasil ketikan) — tidak ada kategori bawaan yang otomatis terpilih, jadi tidak akan tersimpan dengan kategori yang salah/lupa diubah.
