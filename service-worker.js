...
const CACHE_NAME = "essentiapath-cache-v112";
const ASSETS = [
  "./",
  "./index.html",
  "./manifest.json",
...
// Local notifications are triggered by the page itself (see index.html) via
// registration.showNotification(). This click handler just focuses/opens
